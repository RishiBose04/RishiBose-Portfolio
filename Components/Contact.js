    ...
    <div className={styles.contactWrapper}>
      ...
      <form onSubmit={(e) => { handleSubmit(e) }} className={styles.form} style={{ borderColor: currentTheme.text, backgroundColor: currentTheme.name === 'light' ? '#fafafa' : 'transparent' }}>
        <Stack spacing={4}>
          ...
          <Textarea
            ...
            resize="vertical"
            focusBorderColor={currentTheme.secondary}
            isRequired
            name="email"
            value={message}
            autoComplete="off"
          ...
          />
          <div>
            <div className={styles.submit} style={{ backgroundColor: currentTheme.secondary }}>
      ...
      </div>
      {
        userinfo.contact.phone ?
          <div style={{ textAlign: 'center', paddingTop: '0.2rem', color: currentTheme.secondary }}>
